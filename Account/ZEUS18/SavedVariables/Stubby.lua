...
StubbyConfig = {
	...
	["boots"] = {
		["enchantrix"] = {
			...
			["triggers"] = "		if Stubby.GetConfig(\"Enchantrix\", \"LoadType\") == \"always\" then\n			LoadAddOn(\"Enchantrix\")\n		else\n			Stubby.Print(\"Enchantrix no está cargado. Escriba /enchantrix para más información.\")\n		end\n	",
		},
		["informant"] = {
